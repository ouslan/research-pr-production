\block{Datos}{
	...
	producción de energy provista por LUMA Energy como proxy del PIB, debido a que produccion energetica es
	un componente significativo a la producción total \cite{BOROZAN2013373}. Mano de obra proviene del QCEW
	por el departamento del trabajo. Esto abarca a los 78 municipios en un periodo de 36 meses para un total
	de 2808 observaciones.
